...
const WelcomeSection = () => {
  return (
    <section className="bg-gradient-to-r from-indigo-100 via-white to-indigo-100 py-16 sm:py-20 md:py-24 lg:py-32 px-4 sm:px-6 lg:px-8 text-center">
      <div className="max-w-screen-xl mx-auto px-4">
        <div className="max-w-4xl mx-auto space-y-6 animate-fade-in">

          {/* -------- Headline -------- */}
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold text-indigo-800 leading-tight tracking-tight">
            Welcome to{" "}
            <span className="inline-block animate-pop text-indigo-700">
              ExpensePro 💰
            </span>
          </h1>
          ...
          <div className="pt-4 flex justify-center">
            <a href="#dashboard" aria-label="Scroll to dashboard">
              <FaChevronDown className="text-indigo-500 text-2xl sm:text-3xl animate-bounce hover:text-indigo-700 transition" />
            </a>
          </div>
        </div>
      </div>
